...
def adminclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'D:/Sample Project/schoolmanagement-master/templates/school/adminclick.html')
...
def teacherclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'D:/Sample Project/schoolmanagement-master/templates/school/teacherclick.html')
...
def studentclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'D:/Sample Project/schoolmanagement-master/templates/school/studentclick.html')
...
#for TEACHER  LOGIN    SECTIONNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN
